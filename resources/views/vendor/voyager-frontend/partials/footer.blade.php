    ...
    <div class="grid-container">
        <div class="grid-x">
            <div class="cell medium-4 text-center medium-text-left">
                <h6>Registriere dich für unseren Newsletter</h6>
                <div class="input-group">
                    <input class="input-group-field" type="email" placeholder="E-Mail Adresse">
                    <div class="input-group-button">
                        <input type="submit" class="button light" value="Anmelden">
            ...
            <div class="cell medium-6 medium-offset-2 text-center medium-text-right">
                <h6>Wir sind auch auf Social Media</h6>
